...
public class PathVariableController {
    ...
    @Value("#{'${config.listOfValues}'.split(',')}") // SpEL (lenguaje de expresiones de Spring)
    private List<String> valueList;
    @Value("#{'${config.username}'.toUpperCase()}") // SpEL (lenguaje de expresiones de Spring)
    private String valorAmayuscula;
    @Value("${config.code}")
    ...
    public Map<String,Object> values(@Value("${config.message}") String message) {
        ...
        json.put("code",code);
        json.put("valorAmayuscula",valorAmayuscula);
